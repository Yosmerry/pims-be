...
public class TokenService {
  ...
  public IssuedTokens issue(User user, long currentTime) {
    ...
    refreshToken.setId(TsidGenerator.next());
    ...
    refreshToken.setCreatedDate(currentTime);
    refreshToken.setCreatedBy(user.getEmail());
    refreshToken.setUpdatedDate(currentTime);
    refreshToken.setUpdatedBy(user.getEmail());
    refreshTokenRepository.save(refreshToken);

    return new IssuedTokens(
        accessToken,
        authProperties.accessTokenExpiresIn(),
        refreshTokenValue,
        authProperties.refreshTokenExpiresIn());
  }
